...
import MostActiveTechnicalRow from "./MostActiveTechnicalRow";

function MostActiveTechnicalCol({ isLoading, currentData, startIndex }) {
  return (
    <div>
...
export default MostActiveTechnicalCol;
